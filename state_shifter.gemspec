...
# -*- encoding: utf-8 -*-
# stub: state_shifter 1.0.8 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<activerecord>, [">= 4.0.9", "~> 4.0"])
      s.add_development_dependency(%q<sqlite3>, [">= 1.3.10", "~> 1.3"])
      s.add_development_dependency(%q<rspec>, [">= 3.2.0", "~> 3.2.0"])
      ...
      s.add_development_dependency(%q<ruby-graphviz>, [">= 1.2.1", "~> 1.2"])
      s.add_development_dependency(%q<json>, [">= 1.8.2", "~> 1.8"])
      s.add_development_dependency(%q<i18n>, [">= 0.6.6", "~> 0.6"])
      s.add_development_dependency(%q<nokogiri>, [">= 1.6.1", "~> 1.6"])
    else
      s.add_dependency(%q<activerecord>, [">= 4.0.9", "~> 4.0"])
      s.add_dependency(%q<sqlite3>, [">= 1.3.10", "~> 1.3"])
      s.add_dependency(%q<rspec>, [">= 3.2.0", "~> 3.2.0"])
      ...
      s.add_dependency(%q<ruby-graphviz>, [">= 1.2.1", "~> 1.2"])
      s.add_dependency(%q<json>, [">= 1.8.2", "~> 1.8"])
      s.add_dependency(%q<i18n>, [">= 0.6.6", "~> 0.6"])
      s.add_dependency(%q<nokogiri>, [">= 1.6.1", "~> 1.6"])
    end
  else
    s.add_dependency(%q<activerecord>, [">= 4.0.9", "~> 4.0"])
    s.add_dependency(%q<sqlite3>, [">= 1.3.10", "~> 1.3"])
